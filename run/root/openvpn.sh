...
function watchdog() {
	...
	# loop and watch out for files generated by user abc scripts that indicate failure
	while true; do

		# reset flag, used to indicate connection status
		down="false"

		# if '/tmp/portclosed' file exists (generated by /home/abc/watchdog.sh when incoming port
		...
		# if '/tmp/dnsfailure' file exists (generated by /home/abc/checkdns.sh when dns fails)
